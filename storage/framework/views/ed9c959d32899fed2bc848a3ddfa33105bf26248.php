                                ...
                                <form method="POST" action="<?php echo e(route('student.store')); ?>">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault01" name="nama" placeholder="masukan nama" value="<?php echo e(old('nama')); ?>" required="">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault02" placeholder="12345  " value="<?php echo e(old('nis')); ?>" required="" name="nis">
                                        ...
                                        <div class="col-md-4 mb-3">
                                         ...
                                         <input type="text" class="form-control" id="validationDefault02" placeholder="Brebes, 20 april 1999" value="<?php echo e(old('ttl')); ?>" required="" name="ttl">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="08xxxxxxx" required="" name="no_tlp" value="<?php echo e(old('no_tlp')); ?>">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="smp negeri" required="" name="asal" value="<?php echo e(old('asal')); ?>">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault04" placeholder="Pendidikan" required="" name="jurusan" value="<?php echo e(old('jurusan')); ?>">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault05" placeholder="Lajang" required="" name="status" value="<?php echo e(old('status')); ?>">
...
<?php echo $__env->make('student._parsial._master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user1/Unduhan/LaravelPert4/resources/views/student/create.blade.php ENDPATH**/ ?>