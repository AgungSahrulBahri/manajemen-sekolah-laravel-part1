                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01" value="{{ $student->nama}}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault02" placeholder="123456  " value="{{ $student->nis}}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                         ...
                                         <input type="text" class="form-control" id="validationDefault02" placeholder="Brebes, 20 april 1999" value="{{ $student->ttl}}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="08xxxxxxxx" value="{{ $student->no_tlp}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="smp negeri" value="{{ $student->asal}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault04" placeholder="Pendidikan" value="{{ $student->jurusan}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault05" placeholder="Lajang" value="{{ $student->status}}">
