                                ...
                                <form method="POST" action="{{ route('student.update', $student->id) }}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault01" name="nama" placeholder="masukan nama" value="{{ $student->nama }}" required="">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault02" placeholder="123456  " value="{{ $student->nis }}" required="" name="nis">
                                        ...
                                        <div class="col-md-4 mb-3">
                                         ...
                                         <input type="text" class="form-control" id="validationDefault02" placeholder="Brebes, 20 april 1999" value="{{ $student->ttl }}" required="" name="ttl">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="08xxxxxxxx" required="" name="no_tlp" value="{{ $student->no_tlp }}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="smp negeri" required="" name="asal" value="{{ $student->asal }}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault04" placeholder="Pendidikan" required="" name="jurusan" value="{{ $student->jurusan }}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault05" placeholder="Lajang" required="" name="status" value="{{ $student->status }}">
